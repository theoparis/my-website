...
import archLinuxLogo from "./assets/arch-linux.svg";
    ...
    return (
        <div className="bg-gray-800 text-white w-full min-h-screen">
            <Router>
                ...
                <main className="p-6 pl-12 pr-12 flex flex-col justify-center items-center text-center flex-wrap">
                    <Route path="/">
                        <div>
                            <h2 className="text-3xl mb-2">About Me</h2>
                            <p className="text-lg mb-2">
                                My name is Theo and I'm a 17-year-old
                                programmer, gamer and music producer.
                            </p>
                            <div className="mb-6">
                                <Logo w={250} />
                            </div>
                            ...
                            <p className="mb-6">
                                I have worked with languages such as Typescript,
                                and frameworks such as React, Fastify/Express
                                and Tailwind CSS.
                            </p>

                            <h2 className="text-3xl mb-2 flex flex-row">
                                My Workflow{" "}
                                <img
                                    width="32"
                                    className="ml-4 mb-4"
                            ...
                            <p className="flex-col flex justify-center items-start mb-2">
                                On my computers I run a operating system called
                                Arch Linux. I have the i3 window manager
                                installed, which improves my workflow a ton.
                                Having a tiling window manager such as i3 helps
                                me to easily switch between windows and virtual
                                desktops, and to keep my windows organized. I
                                use neovim as my main code editor.
